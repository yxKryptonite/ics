 ...
 */
void _builtin(struct cmdline_tokens tok);
void _BGFG(char ** argv);
void _FG(pid_t pid);
void _kill(char ** argv);
void _prog(char * cmdline, struct cmdline_tokens tok, int bg);
...
/*
 * _BGFG - background and foreground jobs
 */
void _BGFG(char ** argv) {
    struct job_t * job;
    int jid;
...
/*
 * _prog - execute a private program
 */
void _prog(char * cmdline, struct cmdline_tokens tok, int bg) {
    int input_fd = STDIN_FILENO;
    int output_fd = STDOUT_FILENO;
